...
GECM <- dynlm(d(mvilab)~ L(mvilab)+ L(mgvldrsat)+ L(moppldrsat) + L(meoi) + 
            
                d(mgvldrsat) + L(d(mgvldrsat), 1) + d(moppldrsat) +  L(d(moppldrsat),1) + d(meoi) +  L(d(meoi),1)+
                L(d(mvilab),1) + L(d(mvilab),4) + L(d(mvilab),8)
              ,  data=data.ts2)
...
```{r}
stargazer(GECM,GECMHAC, type="latex",
